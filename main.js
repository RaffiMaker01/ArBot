...
const hehe = async (jid, options) => {
  let wm = 'Ari Offc';
  let gambar = 'https://telegra.ph/file/ccdf90556dad5ea6a1c03.jpg';
  try {
    ...
    const fkontak = {
      ...
      message: {
        'contactMessage': {
          'displayName': wm,
          'vcard': `BEGIN:VCARD\nVERSION:3.0\nFN:Xynoz\nORG:Ashoka Uni;\nTEL;type=CELL;type=VOICE;waid=6288294533698:+62 882 9453 3698\nEND:VCARD`,
...
async function connectionUpdate(update) {
  ...
  if (code && code !== DisconnectReason.loggedOut && conn?.ws.readyState !== CONNECTING) {
    ...
    return await hehe('6288294533698' + '@s.whatsapp.net').catch(err => { return !0 })
  }
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.welcome = '✧━━━━━━[ *WELCOME BEBAN KELUARGA* ]━━━━━━✧\n\n┏––––––━━━━━━━━•\n│⫹⫺ @subject\n┣━━━━━━━━┅┅┅\n│( 👋 Hallo @user)\n├[ *INTRO* ]—\n│ *Nama:* \n│ *Umur:* \n│ *Gender:*\n┗––––––━━┅┅┅\n\n––––––┅┅ *DESCRIPTION* ┅┅––––––\n@desc'
  conn.bye = '✧━━━━━━[ *GOOD BYE KEMBALILAH BEBANIN ORTU LUH* ]━━━━━━✧\nSayonara Jangan Kembali Lagi Yah *@user* 👋( ╹▽╹ )'
